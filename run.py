...
if __name__ == "__main__":
    ...
    print("Deducción por alquiler: ", rent_deduc)
    ...
    if compute:
        ...
        st.write(f"Con este sueldo deberías poderte permitir un alquiler de **{max_price_rent[0]}€** mensuales de forma cómoda, y los expertos recomiendan que no superes los **{max_price_rent[1]}€** mensuales en un alquiler.")
        
        
        project_pie_chart(yearly_net, gross_salary_no_tax, ss_deduction, total_retention, divisor=1, name="Distribución Anual")
